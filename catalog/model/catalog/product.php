...
class ModelCatalogProduct extends Model {
    ...
    public function getManufacturers(){
        $query =  $this->db->query("SELECT DISTINCT " . DB_PREFIX . "product.manufacturer_id, " . DB_PREFIX . "manufacturer.name FROM `" . DB_PREFIX . "product`
        INNER JOIN " . DB_PREFIX . "manufacturer ON " . DB_PREFIX . "manufacturer.manufacturer_id = " . DB_PREFIX . "product.manufacturer_id");
